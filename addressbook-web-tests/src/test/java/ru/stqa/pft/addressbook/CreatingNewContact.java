...
public class CreatingNewContact {
    ...
    public void CreatingNewContact() {
        ...
        fillNewContactForm(new ContactDate("Robert", "Honca", "testAddress",
    ...
    private void submitCraetionContact() {
        wd.findElement(By.xpath("//div[@id='content']/form/input[21]")).click();
    }

    private void fillNewContactForm(ContactDate contactDate) {
        wd.findElement(By.name("firstname")).click();
        wd.findElement(By.name("firstname")).clear();
        wd.findElement(By.name("firstname")).sendKeys(contactDate.getFirrstname());
